package it.gotoandplay.smartfoxserver.handlers
{
   ...
   public class SysHandler extends Object implements IMessageHandler
   {
      ...
      public function handleRoomList(param1:Object) : void {
         ...
         var _loc3_:Array = [];
         for each (_loc4_ in param1.body.rmList.rm)
         {
            _loc7_ = int(_loc4_.@id);
            _loc8_ = new Room(_loc7_,_loc4_.n,int(_loc4_.@maxu),int(_loc4_.@maxs),_loc4_.@temp == "1",_loc4_.@game == "1",_loc4_.@priv == "1",_loc4_.@lmb == "1",int(_loc4_.@ucnt),int(_loc4_.@scnt));
            if(_loc4_.vars.toString().length > 0)
            {
               this.populateVariables(_loc8_.getVariables(),_loc4_);
            }
            _loc9_ = _loc2_[_loc7_];
            if(_loc9_ != null)
            {
               _loc8_.setVariables(_loc9_.getVariables());
               _loc8_.setUserList(_loc9_.getUserList());
            }
            _loc3_[_loc7_] = _loc8_;
         }
         this.sfs.setRoomList(_loc3_);
         _loc5_ = {};
         _loc5_.roomList = _loc3_;
         _loc6_ = new SFSEvent(SFSEvent.onRoomListUpdate,_loc5_);
         this.sfs.dispatchEvent(_loc6_);
      }
      ...
      public function handleUserLeaveRoom(param1:Object) : void {
         ...
         var _loc4_:Room = this.sfs.getRoom(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function handlePrivateMessage(param1:Object) : void {
         ...
         if(_loc5_ != null)
         {
            _loc6_ = _loc5_.getUser(_loc3_);
         }
         var _loc7_:Object = {};
         _loc7_.message = Entities.decodeEntities(_loc4_);
         _loc7_.sender = _loc6_;
         _loc7_.roomId = _loc2_;
         _loc7_.userId = _loc3_;
         var _loc8_:SFSEvent = new SFSEvent(SFSEvent.onPrivateMessage,_loc7_);
      ...
      private function handleLeaveRoom(param1:Object) : void {
         ...
         if(_loc3_[_loc2_])
         {
            ...
            _loc5_ = new SFSEvent(SFSEvent.onRoomLeft,_loc4_);
            this.sfs.dispatchEvent(_loc5_);
         }
      }

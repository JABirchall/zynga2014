   ...
   public class ObjectSerializer extends Object
   {
      ...
      private function obj2xml(param1:Object, param2:Object, param3:int=0, param4:String="") : void {
         ...
         else
         {
            if(this.debug)
            {
               param2.xmlStr = param2.xmlStr + this.tabs.substr(0,param3);
            }
            _loc6_ = param1 is Array?"a":"o";
            param2.xmlStr = param2.xmlStr + ("<obj t=\'" + _loc6_ + "\' o=\'" + param4 + "\'>" + this.eof);
         }
         for (_loc5_ in param1)
         {
            ...
            if(_loc7_ == "boolean" || _loc7_ == "number" || _loc7_ == "string" || _loc7_ == "null")
            {
               ...
               if(this.debug)
               {
                  param2.xmlStr = param2.xmlStr + this.tabs.substr(0,param3 + 1);
               }
               param2.xmlStr = param2.xmlStr + ("<var n=\'" + _loc5_ + "\' t=\'" + _loc7_.substr(0,1) + "\'>" + _loc8_ + "</var>" + this.eof);
            }
            else
            {
               if(_loc7_ == "object")
               {
                  ...
                  param2.xmlStr = param2.xmlStr + ("</obj>" + this.eof);
               }
            }
         }
         if(param3 == 0)
         {
            param2.xmlStr = param2.xmlStr + ("</dataObj>" + this.eof);
         }
      }

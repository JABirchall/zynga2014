package it.gotoandplay.smartfoxserver
{
   ...
   public class SmartFoxClient extends EventDispatcher
   {
      ...
      private static var DEFAULT_SOCKET_TIMEOUT:Number = 20000;
      ...
      public function get socketTimeout() : int {
         return this._socketTimeout;
      }
      
      public function set socketTimeout(param1:int) : void {
         if(param1 >= 100 && param1 <= 20000)
         {
            this._socketTimeout = param1;
         }
      }
      ...
      public function connect(param1:String, param2:int=9339) : void {
         if(!this.connected)
         {
            ...
            this.port = param2;
            this.socketConnection.timeout = this._socketTimeout;
      ...
      public function connectBlueBox(param1:String, param2:int=8080) : void {
         if(!this.connected)
         {
            this.initialize();
            this.isHttpMode = true;
            this.httpConnection.connect(param1,param2,this._socketTimeout);
         }
         else
         {
            this.debugMessage("*** ALREADY CONNECTED ***");
      ...
      public function disconnect(param1:Boolean=true) : void {
         ...
         if(!this.isHttpMode && !(this.socketConnection == null) && (this.socketConnection.connected))
         {
            this.socketConnection.close();
         }
         else
         {
            if(!(this.httpConnection == null) && (this.httpConnection.isConnected()))
            {
      ...
      public function createRoom(param1:Object, param2:int=-1) : void {
         ...
         {
            _loc9_ = _loc9_ + ("<uCnt>" + (param1.uCount?"1":"0") + "</uCnt>");
         }
         if(param1.extension != null)
         {
            _loc9_ = _loc9_ + ("<xt n=\'" + param1.extension.name);
            _loc9_ = _loc9_ + ("\' s=\'" + param1.extension.script + "\' />");
         }
         if(param1.vars == null)
         {
            _loc9_ = _loc9_ + "<vars></vars>";
         }
         else
         {
            _loc9_ = _loc9_ + "<vars>";
            ...
            {
               _loc9_ = _loc9_ + this.getXmlRoomVariable(param1.vars[_loc10_]);
            }
            _loc9_ = _loc9_ + "</vars>";
         }
         _loc9_ = _loc9_ + "</room>";
      ...
      public function setBuddyVariables(param1:Array) : void {
         ...
         for (_loc4_ in param1)
         {
            ...
            if(this.myBuddyVars[_loc4_] != _loc5_)
            {
               ...
               _loc3_ = _loc3_ + ("<var n=\'" + _loc4_ + "\'><![CDATA[" + _loc5_ + "]]></var>");
            }
         }
         _loc3_ = _loc3_ + "</vars>";
      ...
      public function setRoomVariables(param1:Array, param2:int=-1, param3:Boolean=true) : void {
         ...
         {
            _loc5_ = _loc5_ + this.getXmlRoomVariable(_loc6_);
         }
         _loc5_ = _loc5_ + "</vars>";
      ...
      public function setUserVariables(param1:Object, param2:int=-1) : void {
         ...
         var _loc5_:User = _loc4_.getUser(this.myUserId);
         _loc5_.setVariables(param1);
         var _loc6_:int = _loc5_.getId();
         for each (_loc7_ in this.getAllRooms())
         {
            _loc9_ = _loc7_.getUser(_loc6_);
            if(!(_loc9_ == null) && !(_loc9_ == _loc5_))
            {
               _loc9_.setVariables(param1);
            }
         }
         _loc8_ = this.getXmlUserVariable(param1);
         this.send(_loc3_,"setUvars",param2,_loc8_);
      }
      ...
      private function writeToSocket(param1:String) : void {
         ...
         {
            handleIOError(new IOErrorEvent("",false,false,"Invalid socket."));
         }
      }
      ...
      private function getXmlRoomVariable(param1:Object) : String {
         ...
         else
         {
            ...
            else
            {
               ...
               {
                  if(_loc3_ == null && _loc7_ == "object" || _loc7_ == "undefined")
                  {
                     _loc6_ = "x";
                     _loc3_ = "";
                  }
         ...
         for (_loc6_ in param1)
         {
            ...
            else
            {
               ...
               else
               {
                  ...
                  {
                     if(_loc3_ == null && _loc5_ == "object" || _loc5_ == "undefined")
                     {
                        _loc4_ = "x";
                        _loc3_ = "";
                     }
            ...
            if(_loc4_ != null)
            {
               _loc2_ = _loc2_ + ("<var n=\'" + _loc6_ + "\' t=\'" + _loc4_ + "\'><![CDATA[" + _loc3_ + "]]></var>");
            }
         }
         _loc2_ = _loc2_ + "</vars>";
         return _loc2_;
      ...
      private function tryBlueBoxConnection(param1:ErrorEvent) : void {
         ...
         if(!this.connected)
         {
            if(this.smartConnect)
            {
               ...
               _loc3_ = this.blueBoxPort != 0?this.blueBoxPort:this.httpPort;
               this.httpConnection.connect(_loc2_,_loc3_,this._socketTimeout);
            }
            else
            {
               this.dispatchConnectionError();
      ...
      private function handleSocketData(param1:Event) : void {
         ...
         while((this.socketConnection.connected) && --bytes >= 0)
         {

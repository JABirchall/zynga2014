package caurina.transitions
{
   ...
   public class Tweener extends Object
   {
      ...
      public static function addTween(param1:Object=null, param2:Object=null) : Boolean {
         ...
         var _loc8_:Number = isNaN(_loc7_.time)?0:_loc7_.time;
         var _loc9_:Number = isNaN(_loc7_.delay)?0:_loc7_.delay;
         ...
         for (_loc5_ in _loc7_)
         {
            if(!_loc11_[_loc5_])
            {
               ...
               {
                  if(_specialPropertyModifierList[_loc5_] != undefined)
                  {
      ...
      public static function addCaller(param1:Object=null, param2:Object=null) : Boolean {
         ...
         var _loc6_:Number = isNaN(_loc5_.time)?0:_loc5_.time;
         var _loc7_:Number = isNaN(_loc5_.delay)?0:_loc5_.delay;

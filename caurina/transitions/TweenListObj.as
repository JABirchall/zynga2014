   ...
   public class TweenListObj extends Object
   {
      ...
      public function toString() : String {
         ...
         for (_loc3_ in this.properties)
         {
            ...
            _loc1_ = _loc1_ + ("[name:" + this.properties[_loc3_].name);
            _loc1_ = _loc1_ + (",valueStart:" + this.properties[_loc3_].valueStart);
            _loc1_ = _loc1_ + (",valueComplete:" + this.properties[_loc3_].valueComplete);
            _loc1_ = _loc1_ + "]";
            _loc2_ = false;
         }
         ...
         _loc1_ = _loc1_ + (", transitionParams:" + String(this.transitionParams));
         if(this.skipUpdates)
         {
         ...
         {
            _loc1_ = _loc1_ + (", onStartScope:" + String(this.onStartScope));
         }
         if(this.onUpdateScope)
         {
            _loc1_ = _loc1_ + (", onUpdateScope:" + String(this.onUpdateScope));
         }
         if(this.onCompleteScope)
         {
            _loc1_ = _loc1_ + (", onCompleteScope:" + String(this.onCompleteScope));
         }
         if(this.onOverwriteScope)
         {
            _loc1_ = _loc1_ + (", onOverwriteScope:" + String(this.onOverwriteScope));
         }
         if(this.onErrorScope)
         {
            _loc1_ = _loc1_ + (", onErrorScope:" + String(this.onErrorScope));
         }
         if(this.rounded)
         {

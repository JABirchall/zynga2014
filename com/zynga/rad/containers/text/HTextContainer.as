package com.zynga.rad.containers.text
{
   ...
   public dynamic class HTextContainer extends BaseTextContainer implements ILayout, IPropertiesBubbler
   {
      
      public function HTextContainer() {
         ...
         assert(false,"HTextContainer " + this + " must contain a TextField");
      }

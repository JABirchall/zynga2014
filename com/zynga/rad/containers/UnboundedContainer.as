package com.zynga.rad.containers
{
   ...
   public dynamic class UnboundedContainer extends BaseUI implements ILayout, IPropertiesBubbler
   {
      
      public function UnboundedContainer() {
         super();
      }
      ...
      public function getLayoutBounds(param1:DisplayObject) : Rectangle {

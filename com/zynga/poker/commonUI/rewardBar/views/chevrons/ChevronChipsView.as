package com.zynga.poker.commonUI.rewardBar.views.chevrons
{
   ...
   public class ChevronChipsView extends ChevronBaseView
   {
      
      public function ChevronChipsView(param1:Number=60, param2:Number=30) {
         super(param1,param2);
      }
      ...
      override public function createChevronBackground(param1:BitmapData=null) : void {
         ...
         this._goldBackground.graphics.beginGradientFill(_loc3_,RewardBarChipsView.GOLD_GRADIENT_COLORS,RewardBarChipsView.GOLD_GRADIENT_ALPHAS,RewardBarChipsView.GOLD_GRADIENT_RATIOS,_loc7_);
      ...
      override public function destroy() : void {
         Tweener.removeTweens(this._silhouette);
         Tweener.removeTweens(this._circle);
         Tweener.removeTweens(this._incrementText);
         Tweener.removeTweens(this._goldBackground);
      }
   }
}

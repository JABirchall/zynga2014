...
{
   public class SCreateNetworkRoom extends Object
   {
      
      public function SCreateNetworkRoom(param1:String, param2:String, param3:String, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) {
         super();
         this.type = param1;
